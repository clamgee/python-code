...
class Ui_CapitalAPI(object):
    def setupUi(self, CapitalAPI):
        ...
        self.actionDisconnectbtn = QAction(CapitalAPI)
        self.actionDisconnectbtn.setObjectName(u"actionDisconnectbtn")
        self.actionDisconnectbtn.setFont(font)
        ...
        self.toolBar.addAction(self.actionDisconnectbtn)
...
#endif // QT_CONFIG(tooltip)
        self.actionDisconnectbtn.setText(QCoreApplication.translate("CapitalAPI", u"\u5831\u50f9\u6e05\u9664", None))
        self.actionDisconnectbtn.setIconText(QCoreApplication.translate("CapitalAPI", u"\u505c\u6b62\u5831\u50f9", None))
#if QT_CONFIG(tooltip)
        self.actionDisconnectbtn.setToolTip(QCoreApplication.translate("CapitalAPI", u"\u65b7\u958b\u6216\u60c5\u9664\u5831\u50f9\u9023\u7dda\u72c0\u614b", None))
#endif // QT_CONFIG(tooltip)
